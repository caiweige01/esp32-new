...
| 3 | [`03_esp32c3_wifi_ws2812_web`](03_esp32c3_wifi_ws2812_web/README.md) | ESP32-C3 开 WiFi 热点，用网页控制 WS2812 动画 | FastLED |
...
如果你偏好命令行，也可以在仓库根目录使用 Arduino CLI 编译示例。下面以教程 3 为例：

```bash
arduino-cli compile \
  --fqbn esp32:esp32:esp32c3 \
  tutorials/03_esp32c3_wifi_ws2812_web/esp32c3_wifi_ws2812_web
```
